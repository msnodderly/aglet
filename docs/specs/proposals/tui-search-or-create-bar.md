...
```
┌──────────────────────────────────────────────────────┐
│ Aglet Reborn  view:MyView  mode:Normal              │  header (1 line)
├──────────────────────────────────────────────────────┤
...
```
┌──────────────────────────────────────────────────────┐
│ Aglet Reborn  view:MyView                           │  header (1 line)
├──────────────────────────────────────────────────────┤
...
pub(crate) fn handle_search_bar_key(
    &mut self, code: KeyCode, workspace: &Workspace<'_>,
) -> Result<bool, String> {
    match code {
        KeyCode::Esc => {
        ...
        KeyCode::Enter => {
            ...
            if query.is_empty() {
                ...
                self.open_add_item_with_title(query, workspace)?;
            }
        }
...
fn open_add_item_with_title(&mut self, title: String, workspace: &Workspace<'_>) -> Result<(), String> {
