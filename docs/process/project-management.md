...
`../aglet-features.ag` is the canonical local PM backlog database for Aglet.
...
git add docs/process/project-management.md archive/notes/questions.md
...
- [ ] Docs committed; local `../aglet-features.ag` changes intentionally remain outside git
