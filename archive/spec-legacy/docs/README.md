...
Flat docs layout by prefix:

- `guide-*.md`: usage/reference guides
- `demo-*.md`: executable demos and walkthrough logs
- `test-*.md`: scenario definitions and test run outputs
